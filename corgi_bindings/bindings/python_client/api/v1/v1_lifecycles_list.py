...
def _parse_response(*, response: requests.Response) -> Optional[PaginatedAppStreamLifeCycleList]:
...
def _build_response(*, response: requests.Response) -> Response[PaginatedAppStreamLifeCycleList]:
    return Response(
