...
T = TypeVar("T", bound="PaginatedProductVariantList")


@attr.s(auto_attribs=True)
class PaginatedProductVariantList(ComponentRegistryModel):
    """ """

    count: Union[Unset, int] = UNSET
    next_: Union[Unset, None, str] = UNSET
    previous: Union[Unset, None, str] = UNSET
    results: Union[Unset, List[ProductVariant]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _results is UNSET:
            ...
            for results_item_data in _results or []:
                ...
                results_item: ProductVariant
                if isinstance(_results_item, Unset):
                    results_item = UNSET
                else:
                    results_item = ProductVariant.from_dict(_results_item)

                results.append(results_item)

        paginated_product_variant_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_product_variant_list.additional_properties = d
        return paginated_product_variant_list
