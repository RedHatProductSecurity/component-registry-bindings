...
class PaginatedComponentList:
    ...
    results: Union[Unset, List[Component]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _results is UNSET:
            ...
            for results_item_data in _results or []:
                ...
                results_item: Component
                if isinstance(_results_item, Unset):
                    results_item = UNSET
                else:
                    results_item = Component.from_dict(_results_item)

                results.append(results_item)

        paginated_component_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_component_list.additional_properties = d
