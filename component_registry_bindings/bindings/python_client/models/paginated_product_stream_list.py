...
class PaginatedProductStreamList:
    ...
    results: Union[Unset, List[ProductStream]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _results is UNSET:
            ...
            for results_item_data in _results or []:
                ...
                results_item: ProductStream
                if isinstance(_results_item, Unset):
                    results_item = UNSET
                else:
                    results_item = ProductStream.from_dict(_results_item)

                results.append(results_item)

        paginated_product_stream_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_product_stream_list.additional_properties = d
