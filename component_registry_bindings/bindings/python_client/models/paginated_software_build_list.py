...
T = TypeVar("T", bound="PaginatedSoftwareBuildList")


@attr.s(auto_attribs=True)
class PaginatedSoftwareBuildList(ComponentRegistryModel):
    """ """

    count: Union[Unset, int] = UNSET
    next_: Union[Unset, None, str] = UNSET
    previous: Union[Unset, None, str] = UNSET
    results: Union[Unset, List[SoftwareBuild]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _results is UNSET:
            ...
            for results_item_data in _results or []:
                ...
                results_item: SoftwareBuild
                if isinstance(_results_item, Unset):
                    results_item = UNSET
                else:
                    results_item = SoftwareBuild.from_dict(_results_item)

                results.append(results_item)

        paginated_software_build_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
