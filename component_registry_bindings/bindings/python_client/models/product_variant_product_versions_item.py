...
T = TypeVar("T", bound="ProductVariantProductVersionsItem")


@attr.s(auto_attribs=True)
class ProductVariantProductVersionsItem(ComponentRegistryModel):
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        product_variant_product_versions_item = cls()
